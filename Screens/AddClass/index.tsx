  ...
  const getTutorStudents = async () => {
    ...
    axios
      ...
      .then(({data}) => {
        ...
        const activeStudents = tutorStudents.filter(
          (tutorStudents: any) => tutorStudents.studentStatus === 'active',
        );
        let myStudents =
          activeStudents &&
    ...
    return (
      <View>
        <View
          ...
          <Text style={[styles.textType1, {fontSize: 18, fontWeight: '600'}]}>
            Session {index + 1}
          </Text>
          <TouchableOpacity
            activeOpacity={0.8}
        ...
        <View
          ...
          <View style={{width: '49%'}}>
            <Text style={[styles.textType1, {fontSize: 16}]}>Start Time</Text>
            <View
              style={{
                flexDirection: 'row',
                justifyContent: 'space-between',
                ...
                <View style={{marginVertical: 10}}>
                  ...
                  <View
                    ...
                    <Text
                      style={[
                        styles.textType3,
                        {lineHeight: 23, color: 'gray'},
                      ]}>
                      Great job on completing one of your (
                      {selectedSubject?.classFrequency}) monthly sessions for
                      this subject! You now have ({MAX_CLASSES}) sessions left.
